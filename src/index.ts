...
/** Codec for a dynamic or fixed-size UTF-8 encoded string. */
...
export const encode = <T>(bincode: BinCode<T>, value: T) => {
...
export const decode = <T>(bincode: BinCode<T>, value: Uint8Array) => bincode.d(reader(value))
